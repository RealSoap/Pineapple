    ...
    .directive('hookModal', function(){
        return {
                ...
                <div class="modal-content"> \
                    ...
                    <div class="modal-body"> \
                        <div id="ssid-actions" ng-if="hook == \'ssid\' && content != \'\'"> \
                            <h4>Profiling</h4> \
                            <button type="button" class="btn btn-default" ng-click="addSSIDToProfiling()">Add SSID</button> \
                            <hr> \
                            <h4>PineAP Pool</h4> \
                        ...
                        <div id="mac-actions" ng-if="hook == \'mac\'"> \
                            <div ng-if="!deauth">\
                                <h4>Profiling</h4> \
                                <button type="button" class="btn btn-default" ng-click="addBSSIDToProfiling()">Add MAC</button> \
                                <hr> \
                            </div>\
                            <h4>PineAP Filter</h4> \
            ...
            controller: ['$scope', '$api', '$timeout', function($scope, $api, $timeout){
                ...
                $scope.addSSIDToProfiling = (function() {
                    $api.request({
                        module: 'Profiling',
                        action: 'addSSID',
                        ssid: $scope.content
                ...
                $scope.addBSSIDToProfiling = (function() {
                    $api.request({
                        module: 'Profiling',
                        action: 'addBSSID',
                        bssid: $scope.content
