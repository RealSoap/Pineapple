...
class Advanced extends SystemModule
{
    ...
    private function checkForUpgrade()
    {
        ...
        $upgradeData = @file_get_contents("https://www.wifipineapple.com/tetra/upgrades", false, $context);
    ...
    private function downloadUpgrade()
    {
        ...
        $this->execBackground("wget 'https://www.wifipineapple.com/tetra/upgrades/{$version}' -O /tmp/upgrade.bin && touch /tmp/upgradeDownloaded");
        $this->response = array("success" => true);
    }
