...
class ModuleManager extends SystemModule
{
    ...
    private function getAvailableModules()
    {
        ...
        $moduleData = @file_get_contents('https://www.wifipineapple.com/tetra/modules', false, $context);
    ...
    private function downloadModule()
    {
        ...
        $this->execBackground("wget 'https://www.wifipineapple.com/tetra/modules/{$this->request->moduleName}' -O {$dest}{$this->request->moduleName}.tar.gz && touch /tmp/moduleDownloaded");
